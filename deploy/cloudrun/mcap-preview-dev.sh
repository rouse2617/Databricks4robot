...
GRACE_TOKEN_PASSTHROUGH="${GRACE_TOKEN_PASSTHROUGH:-true}"
...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --concurrency 2 \
  --timeout 600 \
  --set-env-vars "UPSTREAM_BASE_URL=${UPSTREAM_BASE_URL},GCS_PAGE_SIZE_BYTES=${GCS_PAGE_SIZE_BYTES},GCS_PAGE_CACHE_BYTES=${GCS_PAGE_CACHE_BYTES},LOG_LEVEL=${LOG_LEVEL},LOG_FORMAT=${LOG_FORMAT},GRACE_TOKEN_PASSTHROUGH=${GRACE_TOKEN_PASSTHROUGH}"
