...
#   - Iceberg stack running (docker-compose.iceberg.yml)
...
TRINO_CMD="docker compose -f deploy/local/docker-compose.iceberg.yml exec -T trino trino --server http://localhost:8080 --catalog iceberg --schema robot --output-format CSV"
