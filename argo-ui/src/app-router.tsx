...
import {WorkflowCanvas} from './workflows/components/workflow-canvas/workflow-canvas';
                    ...
                    <Layout
                        ...
                        <ErrorBoundary>
                            <Switch>
                                ...
                                <Route exact={true} path={uiUrl('workflows/new')} component={WorkflowCanvas} />
