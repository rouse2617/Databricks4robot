...
设计规格已沉淀到 [`DESIGN.md`](./DESIGN.md)，方向是 Linear-style product shell + PostHog/Sentry-style observability panels。新页面与组件应优先遵循该文件；实现层以 `src/index.css` 的 CSS 变量 / Ant Design 覆写和 `src/main.tsx` 的 `ConfigProvider` theme 为准。

当前风格为 SaaS Data-Dense Dashboard：
...
<!-- tekton smoke test: 2026-05-14T08:06:19Z -->
