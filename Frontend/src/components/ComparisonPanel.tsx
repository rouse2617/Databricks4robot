...
import { Divider, Empty, Button, Space, Checkbox } from 'antd';
  ...
  return (
    <div style={{ padding: '24px' }}>
      <div style={{ marginBottom: '16px', display: 'flex', justifyContent: 'space-between' }}>
        <h3>
          版本对比：v{version1.version} ({version1.updatedAt?.slice(0, 10)}) vs v
          {version2.version} ({version2.updatedAt?.slice(0, 10)})
        </h3>
        <Space>
          <Checkbox
