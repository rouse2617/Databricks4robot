...
function PreviewMediaPanel({ manifest }: { manifest: PreviewManifest | null }) {
  ...
  return (
    ...
    >
      <FileImageOutlined style={{ fontSize: 48, color: "#bfbfbf", marginBottom: 12 }} />
      <Text type="secondary" style={{ fontSize: 14, marginBottom: 8 }}>
        暂无预览
      </Text>
      <Badge
        status={badge.status}
        text={<Text type="secondary" style={{ fontSize: 12 }}>{badge.text}</Text>}
      />
...
export default function AssetPreviewHero({
  ...
  return (
    ...
    >
      ...
      >
        <PreviewMediaPanel manifest={previewManifest} />
