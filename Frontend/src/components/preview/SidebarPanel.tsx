...
export default function SidebarPanel({
  ...
  return (
    ...
    >
      {/* File info section */}
      <div>
        <Text strong style={{ fontSize: "var(--font-size-base)", color: "var(--gray-800)" }}>
          MCAP 文件信息
        </Text>
        <Descriptions
          column={1}
          ...
          style={{ marginTop: 8 }}
          styles={{
            label: { fontSize: "var(--font-size-sm)", color: "var(--gray-500)", paddingBottom: 4 },
            content: { fontSize: "var(--font-size-sm)", fontFamily: "var(--font-mono)", color: "var(--gray-700)" },
          }}
        >
      ...
      <div>
        ...
        />
        {vizMode === "3d" ? (
          <div style={{ height: 300, borderRadius: "var(--radius-md)", overflow: "hidden" }}>
            <Viewport3D />
          </div>
        ) : vizMode === "chart" ? (
          <TimeSeriesChart
