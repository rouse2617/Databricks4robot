			...
			<div style={{ display: "grid", gap: "16px" }}>
				...
				>
					<div>
						...
						>
							<div>
								<strong>版本 {yourVersion.version}</strong>
							</div>
					...
					<div>
						...
						>
							<div>
								<strong>版本 {latestVersion.version}</strong>
							</div>
							<div style={{ color: "#666", marginTop: "4px" }}>
								修改于：
								{latestVersion.updatedAt?.slice(0, 19).replace("T", " ")}
							</div>
							<div style={{ color: "#666", marginTop: "4px" }}>
				...
				<div style={{ display: "grid", gap: "12px" }}>
					<div>
						...
						<Space direction="vertical" style={{ width: "100%" }}>
							<Button block type="default" onClick={onViewDiff}>
								📊 查看差异（推荐）
							</Button>
					...
					<div>
						<Space direction="vertical" style={{ width: "100%" }}>
							<Button block type="primary" danger onClick={onOverwrite}>
								⚡ 覆盖最新版本
							</Button>
							<div style={{ fontSize: "12px", color: "#666" }}>
