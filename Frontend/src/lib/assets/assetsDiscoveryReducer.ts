...
function withQueryReset(state: AssetsDiscoveryState, queryState: QueryState): AssetsDiscoveryState {
  return {
    ...state,
...
export function assetsDiscoveryReducer(
  ...
  switch (action.type) {
    ...
    case "SET_SEARCH_DRAFT":
      return {
        ...state,
        searchUiState: { ...state.searchUiState, draftText: action.payload.text },
      };
    ...
    case "TOGGLE_SUGGESTIONS":
      return {
        ...state,
        searchUiState: { ...state.searchUiState, suggestionsOpen: action.payload.open },
      };

    case "SET_HIGHLIGHTED_INDEX":
      return {
        ...state,
        searchUiState: { ...state.searchUiState, highlightedIndex: action.payload.index },
      };

    case "TOGGLE_HELP":
      return {
        ...state,
        searchUiState: { ...state.searchUiState, helpOpen: action.payload.open },
      };
    ...
    case "SET_SELECTED_COLUMNS":
      return {
        ...state,
        queryState: { ...state.queryState, selectedColumns: action.payload.columns },
      };
    ...
    case "FACET_TOGGLE": {
      ...
      const newFilters = existing
        ...
        : [...state.queryState.activeFilters, createFilterChip(field, "eq", value, "facet")];
      return withQueryReset(state, {
        ...state.queryState,
        activeFilters: newFilters,
      });
    ...
    case "TOGGLE_ADD_FILTER":
      return {
        ...state,
        facetUiState: { ...state.facetUiState, addFilterOpen: action.payload.open },
      };
    ...
    case "RESULTS_LOADING":
      return {
        ...state,
        resultsState: { ...state.resultsState, fetchStatus: "loading", error: null },
      };
