...
import { runDetailPath } from "../../lib/runNavigation";
...
function PipelineCanvas({ onDirtyChange }: PipelineCanvasProps) {
	...
	const assertPipelineSaveable = useCallback(
		(pipeline: Pipeline, actionLabel: string) => {
	...
	const handleSave = useCallback(async () => {
		try {
			...
			if (!assertPipelineSaveable(pipeline, "保存")) return;
...
export default function PipelineDesignerPage() {
	...
	return (
		<div className="pipeline-tabs-page pipeline-figma-kit">
			<Tabs
				activeKey={activeTab}
