...
> 这是 `assets-discovery-ux-spec.md` 的配套低保真 wireframe。
>
> 目标不是表达视觉风格，而是把页面结构、信息层级、关键交互位和未来扩展位画清楚。
>
> 对应的组件树与状态图：`assets-discovery-component-state-map.md`
>
> 对应的实施计划：`assets-discovery-frontend-implementation-plan.md`
