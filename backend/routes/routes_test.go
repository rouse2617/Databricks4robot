...
func TestRegisterAll(t *testing.T) {
	...
	RegisterAll(r, cfg, nil, assetHandler, mcapHandler, deliveryHandler, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestPodTerminalAttachRouteUsesAttachTokenBeforeAPIAuth(t *testing.T) {
	...
	RegisterAll(r, cfg, nil, assetHandler, mcapHandler, deliveryHandler, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, workflowHandler, nil, nil, nil, nil, nil)
...
func TestAuditSearchRouteRegisteredWhenHandlerProvided(t *testing.T) {
	...
	RegisterAll(r, cfg, nil, assetHandler, mcapHandler, deliveryHandler, nil, nil, nil, nil, auditH.New(nil), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestAdminRoutes_DisabledInProductionWithoutAdminToken(t *testing.T) {
	...
	RegisterAll(r, cfg, nil, assetHandler, mcapHandler, deliveryHandler, nil, nil, nil, nil, nil, nil, nil, nil, adminHandler, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestActionRoutes_PatchAndDeleteRegistered(t *testing.T) {
	...
	RegisterAll(r, cfg, nil, assetHandler, mcapHandler, deliveryHandler, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, actionHandler, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
