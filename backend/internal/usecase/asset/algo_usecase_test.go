...
func (m *mockAssetRepo) Get(_ context.Context, assetID string) (*models.Asset, error) {
	return m.GetAll(nil, assetID)
}

func (m *mockAssetRepo) GetAll(_ context.Context, assetID string) (*models.Asset, error) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *mockAssetEventRepo) ListPendingSafe(ctx context.Context, lag time.Duration, limit int) ([]*models.AssetEvent, error) {
	_ = lag
