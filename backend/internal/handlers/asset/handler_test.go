...
func (m *handlerAssetEventRepo) CursorSeq(context.Context, string) (int64, error) {
	return 0, nil
}

func (m *handlerAssetEventRepo) AdvanceCursor(context.Context, string, int64) error {
	return nil
}
