...
func (r *stubAssetRepo) Get(context.Context, string) (*models.Asset, error) { return nil, nil }
...
func (r *stubAssetRepo) ListWithFilters(_ context.Context, whereSQL string, args []interface{}, page, pageSize int, orderBy string) ([]*models.Asset, int64, error) {
	r.lastWhereSQL = whereSQL
	r.lastArgs = append([]interface{}{}, args...)
	r.lastPage = page
	r.lastPageSize = pageSize
	r.lastOrderBy = orderBy
	return []*models.Asset{{
		AssetID:        "aset0001",
		McapFileID:     "mcap0001",
		AssetType:      "segment",
