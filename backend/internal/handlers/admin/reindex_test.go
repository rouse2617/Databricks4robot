...
func (r *reindexAssetRepo) Get(_ context.Context, assetID string) (*models.Asset, error) {
...
func (r *reindexAssetRepo) ListWithFilters(_ context.Context, _ string, _ []interface{}, page, pageSize int, _ string) ([]*models.Asset, int64, error) {
