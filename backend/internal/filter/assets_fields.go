...
var exactFieldSpecs = map[string]fieldSpec{
	...
	"logical_asset_id":   {Canonical: "logical_asset_id", StorageField: "logical_asset_id", IsJSONB: false},
	"revision":           {Canonical: "revision", StorageField: "revision", IsJSONB: false},
	"is_current":         {Canonical: "is_current", StorageField: "is_current", IsJSONB: false},
