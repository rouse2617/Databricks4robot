...
const pipelineUrl = uiUrl('pipeline');
                ...
                <Switch>
                    ...
                    <Layout
                        ...
                        navItems={[
                            ...
                            {
                                title: 'Pipeline',
                                path: pipelineUrl + namespaceSuffix,
                                iconClassName: 'fa fa-project-diagram'
                            },
                            {
                        ...
                        <ErrorBoundary>
                            <Switch>
                                ...
                                <Route path={pipelineUrl} component={pipelineDesigner.component} />
