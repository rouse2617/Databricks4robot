...
- [x] `GET /api/v1/assets/{id}/provenance` (usecase + handler + route)
- [x] Unit tests for version_history assembly
- [x] `api/openapi.yaml` + `docs/review/api-guide.md` + smoke
- [x] Frontend types, API client, version selector on detail page
