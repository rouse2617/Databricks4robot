...
CREATE TABLE "asset_metrics" (
  ...
  "updated_at" timestamptz NOT NULL DEFAULT now(),
  PRIMARY KEY ("asset_id", "target_type", "target_id", "metric_key", "eval_name", "eval_version", "recorded_at")
);
...
CREATE TABLE "mcap_files" (
  ...
  "summary_index_version" text NULL,
  "summary_indexed_at" timestamptz NULL,
  "summary_index_attempts" integer NOT NULL DEFAULT 0,
  "summary_index_error" text NULL,
